...
// Create a bearer token from https://secrets-api.appbrewery.com/
// Add your own bearer token here.
...
app.post("/post-secret", async (req, res) => {
  const enterSecret = req.body.secret;
  const enterScore = req.body.score;
  try {
